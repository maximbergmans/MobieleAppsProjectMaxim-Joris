 ...
 * becomes available.
 */
public class MainActivity extends /*ActionBarActivity,*/ FragmentActivity implements OnMapReadyCallback,
    ...
    public void populateGeofenceList() {
        for (Map.Entry<String, LatLng> entry : Constants.GEO_PLACES.entrySet()) {
